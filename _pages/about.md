...
redirect_from: 
  ...
  - /about.html
---
My research agenda is to use Artificial Intelligence techniques such as word embeddings, deep neural networks, generative models, reinforcement learing, supervised learning, data mining into finance areas like regulations, norms and human biases and asset pricing. 
...
2. **[The Political Economy of Financial Regulation](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4250919)**\
...
3. **[Human-Centred AI investor sing deep generative models, reinforcement learning and prospect theory]()**

4. **Economic Nowcasting Using Deep Generative Adversarial Models**

5. **High-Resolution Satellite Imagery, Deep Learning, and Return Predictability**
