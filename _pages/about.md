...
Market power in the US has been rising over the last 40 years. However, the causes remain largely unknown. Rise in regulations and their potential disproportionate impact on small firms can lead to increase in market power of large firms. To investigate this, we construct a comprehensive regulatory cost measure in dollars using data reported by regulators. We use supervised machine learning on regulatory documents to create the compliance costs for social regulations (e.g., environmental regulations) at the 6-digit NAICS level for small and large firms. Using the measure, we present three main findings. First, we establish two novel facts: (i) regulatory costs have increased by \$1 trillion from 1970 to 2018; (ii) small firms face higher costs than large firms even after massive attempts from regulators and politicians to limit the burden on small firms. Second, exploiting variation created by federal regulations within state-industry-time groups, we find that regulatory costs result in lower (higher) sales, employment, markups, and profitability for small (large) firms. Third, we explore the political economy of rulemaking and find that large firms push for the passage of regulations that has adverse impact on small firms. Overall, we estimate that increased regulations can explain 31-37\% of the rise in market power
</small><br><br/></div>
